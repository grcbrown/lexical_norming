let trial_objects = [
    {
        "stimulus": ['<p style="font-weight:bold;">'+"Do you see a yellow cup?"+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "masc",
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"At the pier, I took a cool photo of the sea."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "masc", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"My fault, I didn't see you there."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "masc", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"That room had one foul scent."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "masc", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"I fully believed that scene."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "masc", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"We thought your talk sounded good."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "masc", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"Hell no, I'm not saying that."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "non_masc", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"I was giggling during the whole comedy set."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "non_masc", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"The party will be so lovely."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "non_masc", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"My final set had me feeling empowered."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "non_masc", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"I saw you got a new lilac mug."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "non_masc", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"I said that movie looked utterly entertaining."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "non_masc", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"Sam looked awfully tired on Monday."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "non_masc", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"I bought a new suit for Todd."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "neutral", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"Hey, you won't believe who I bumped into on Saturday."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "neutral", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"That article seemed well-written."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "neutral", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"We had a wonderful summer."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "neutral", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"That seminar was fairly boring."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "neutral", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"The cook prepared the flavorful soup."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "neutral", 
    ...
    {
        "stimulus": ['<p style="font-weight:bold;">'+"I hear what you're saying, Cam."+'</p>'+"<br><br>How masculine is the speaker of this sentence?<br><br>"],
        "expected": "neutral", 
